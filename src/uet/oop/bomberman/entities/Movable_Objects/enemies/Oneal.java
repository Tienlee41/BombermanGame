...
import uet.oop.bomberman.map.Graph;
import uet.oop.bomberman.map.Vertices;
...
public class Oneal extends Enemy implements HardEnemy {
     ...
     */
    public Oneal(int xUnit, int yUnit, Collision collision) {
        super(xUnit, yUnit, Sprite.oneal_right1.getFxImage(), collision);
    }
     ...
     */
    public void moveAlongPath(List<Vertices> path) {
     ...
     */
    public void move() {
        graph = collision.getMap().convertMapToGraph(new Vertices(x / Sprite.SCALED_SIZE, y / Sprite.SCALED_SIZE));
